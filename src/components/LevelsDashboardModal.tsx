            ...
            <div style={{
              ...
              <div style={{ flex: 1, position: 'relative', display: 'flex', alignItems: 'center' }}>
                ...
                <div style={{
                  ...
                  <span style={{ display: 'flex', alignItems: 'center', gap: '3px', color: '#60a5fa' }}><span style={{ display: 'inline-block', width: '5px', height: '5px', borderRadius: '50%', background: '#60a5fa' }}></span>Vocab</span>
